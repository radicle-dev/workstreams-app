	...
	<div slot="body">
		...
		<form>
			<div class="input-with-label">
				...
				<TextInput bind:value={applicationText} textarea placeholder="Markdown supported" />
			</div>
			<div class="payment">
		...
		<div class="actions">
			<Button disabled={creatingApplication} variant="outline" on:click={modal.hide}>Cancel</Button>
			<Button
				icon={Apply}
