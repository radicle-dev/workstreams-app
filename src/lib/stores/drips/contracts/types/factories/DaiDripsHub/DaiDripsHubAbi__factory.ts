...
import type {
  DaiDripsHubAbi,
  DaiDripsHubAbiInterface
} from '../../DaiDripsHub/DaiDripsHubAbi';
...
export class DaiDripsHubAbi__factory {
  static readonly abi = _abi;
  static createInterface(): DaiDripsHubAbiInterface {
    return new utils.Interface(_abi) as DaiDripsHubAbiInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): DaiDripsHubAbi {
    return new Contract(address, _abi, signerOrProvider) as DaiDripsHubAbi;
  }
}
